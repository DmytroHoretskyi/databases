...
public class MyView {
    ...
    private Car getCarInputs() {
        ...
        return new Car(carModel, carMark, carColor, carNumber);
    }
    ...
    private Driver getDriverInputs() {
        ...
        System.out.println("Enter raiting_idraiting ");
        Integer driverRaiting = SCANNER.nextInt();
        return new Driver(driverName,driverSurname,driverAge,driverNumberOfCars,driverExperience,driverRaiting);
    }
    ...
    private Route getRouteInputs() {
        ...
        System.out.println("\nEnter User_iduser: ");
        Integer routeUser = SCANNER.nextInt();
        System.out.println("\nEnter driver_iddriver: ");
        Integer routeDriver = SCANNER.nextInt();
        return new Route(routeStart,routeEnd,routeData,routePrice,routeUser,routeDriver);
    }
    ...
    private User getUserInputs() {
        ...
        return new User(userAge,userName, userSurname, userGender);
    }
